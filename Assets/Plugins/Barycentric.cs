...
namespace Plugins
{
    public struct Barycentric
    {
        ...
        public Barycentric(Color aV1, Color aV2, Color aV3, Color aP)
        {
            ...
            var aLen = a.r * a.r + a.g * a.g + a.b * a.b;
            var bLen = b.r * b.r + b.g * b.g + b.b * b.b;
            var ab = a.r * b.r + a.g * b.g + a.b * b.b;
            var ac = a.r * c.r + a.g * c.g + a.b * c.b;
            var bc = b.r * c.r + b.g * c.g + b.b * c.b;
            var d = aLen * bLen - ab * ab;
            u = (aLen * bc - ab * ac) / d;
            v = (bLen * ac - ab * bc) / d;
            w = 1.0f - u - v;
